...
if(Sys.info()["sysname"] == "Windows"){ # working directory for my windows machine
    knitr::opts_knit$set(root.dir = "~/GitHub/predictive-text-model-swift-key/app")
} else { # working directory for my Macbook Pro
    knitr::opts_knit$set(root.dir = "~/Documents/GitHub/predictive-text-model-swift-key/app")
}
